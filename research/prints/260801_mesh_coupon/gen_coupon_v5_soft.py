...
combined.export("mesh_coupon_v5_soft.stl")
vol = combined.volume / 1000.0
print(f"STL out: mesh_coupon_v5_soft.stl  triangles={len(combined.faces)}")
...
ax.set_title("mesh coupon v5 soft re-entrant — as printed (already open)")
fig.savefig("preview_v5_soft.png", dpi=150, bbox_inches="tight")
print("preview: preview_v5_soft.png")
