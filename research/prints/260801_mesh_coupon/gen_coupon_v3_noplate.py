...
combined.export("mesh_coupon_v3_noplate.stl")
vol = combined.volume / 1000.0
print(f"STL out: mesh_coupon_v3_noplate.stl  triangles={len(combined.faces)}")
...
ax.set_title("mesh coupon v3 no-plate — pure mesh baseline")
fig.savefig("preview_v3_noplate.png", dpi=150, bbox_inches="tight")
print("preview: preview_v3_noplate.png")
